<template>
  <div class="absolute z-10 font-ubuntu items-center justify-center inset-0">
    <div
      class="
    ...
    >
      <div
        ...
        "
      >
        <div class="w-full md:w-1/2  text-GreenLizard">
          <div class="mb-10 lg:mb-20">
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-GreenLizard to-GreenSheen font-ubuntu text-7xl font-bold tracking-wider"> Skynet</span>
          </div>
          <div class="mb-10 md:mb-20 font-light">
            ...
            <p class="tracking-wider">The page you're looking for isn't available.</p>
            <p class="tracking-wider">Try searching again or use the Go Back button below.</p>
          </div>
