    ...
    <div class="md:flex justify-around text-GreenLizard p-10 space-y-9 md:space-y-0">
      ...
      <div class="space-y-3">
        ...
        <div class="flex space-x-1"> 
          ...
          </span><span>info@skynet.com</span>
        </div>
      </div>
      <div class="space-y-2">
        ...
        <div class="font-light uppercase cursor-pointer text-lg py-5 border border-GreenLizard justify-center flex">Check out our services</div>
