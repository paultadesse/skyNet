<template>
  <div :class="lightMode ? '' : 'dark'">
    ...
    <div class="flex items-center justify-end dark:bg-gray-900 border-none">
      <div class="mr-20 cursor-pointer" v-on:click="lightMode = !lightMode">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          :class="lightMode ? 'h-6 w-6 text-blue-900' : 'h-6 w-6 text-blue-400'"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
    ...
    >
      ...
      <div
        class="w-32 border-b-2 border-blue-900 dark:border-blue-400 pt-10"
      ></div>
    </div>
    ...
    <div class="font-poppins dark:bg-gray-900">
      ...
      >
        ...
        >
          ...
          <p class="font-bold pt-2 pb-2 text-blue-900 dark:text-blue-300">
            Server setup
          </p>
          <div
          ...
          <p class="text-sm text-gray-500 dark:text-blue-300 pt-2">
    ...
    >
      <div
        ...
        "
      >
        <div class="divide-y divide-gray-200 dark:divide-blue-400">
        ...
        <div class="pt-8 space-y-2 flex flex-col items-center">
          <div class="flex space-x-2 items-center" v-for="i in 4" :key="i">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
              viewBox="0 0 20 20"
      ...
      >
        <div class="flex justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-16 w-16 pb-2 dark:text-blue-100"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div class="divide-y dark:divide-blue-400">
